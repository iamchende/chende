...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //用公钥加密
        byte[] encryptByPublicKey = encryptByPublicKey("我是公钥加密数据！".getBytes(), pub);
        //用公钥解密会报错
        //byte[] decryptByPublicKey = decryptByPublicKey(encryptByPublicKey, pub);
        byte[] decryptByPrivateKey = decryptByPrivateKey(encryptByPublicKey, pri);
        System.out.println(new String(decryptByPrivateKey));
        
        //用私钥加密
        byte[] encryptByPrivateKey = encryptByPrivateKey("我是私钥加密数据！".getBytes(), pri);
        //用私钥解密会报错
        //decryptByPrivateKey = decryptByPrivateKey(encryptByPrivateKey, pri);
        byte[] decryptByPublicKey = decryptByPublicKey(encryptByPrivateKey, pub);
        System.out.println(new String(decryptByPublicKey));
        
        String sign = sign("我是数字签名".getBytes(), pri);
        System.out.println(verify("我是数字签名".getBytes(), pub, sign));
        //用私钥或其他验签会报错；签名变了则返回false
        //System.out.println(verify("我是数字签名".getBytes(), pri, sign));
